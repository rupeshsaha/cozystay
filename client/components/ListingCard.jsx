...
const ListingCard = ({ data }) => {
  return (
    <div className="bg-white dark:bg-neutral-800 rounded-lg overflow-hidden shadow-lg transition-transform duration-300 hover:shadow-xl hover:-translate-y-2 flex flex-col min-h-[450px]">
      {/* Image Section */}
